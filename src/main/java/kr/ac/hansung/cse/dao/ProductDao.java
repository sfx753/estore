...
public class ProductDao {
	...
	@Autowired
	public void setDataSource(DataSource dataSource) {// datasource瑜� �쓽議댁꽦�뿉 �쓽�빐 二쇱엯�븷 �삁�젙 �씠�븣 ->jdbcTemplate 媛앹껜�뿉
														// ���옣
	...
	public List<Product> getProducts() {
		...
		return jdbcTemplate.query(sqlStatement, new RowMapper<Product>() {// RowMapper -> record瑜� 媛앹껜�뿉 留듯븨�빐二쇰뒗 寃껋씠
																			// �븘�슂
	...
	public Product getProductById(int id) {
		...
		return jdbcTemplate.queryForObject(sqlStatement, new Object[] { id },new RowMapper<Product>() {// RowMapper -> record瑜� 媛앹껜�뿉 留듯븨�빐二쇰뒗 寃껋씠
																			// �븘�슂
